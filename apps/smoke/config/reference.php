 ...
 * }
 * @psalm-type MyFrameworkCoreConfig = array{
 *     push?: array{
 *         vapid_public_key?: scalar|Param|null, // Default: "%env(resolve:VAPID_PUBLIC_KEY)%"
 *         vapid_private_key?: scalar|Param|null, // Default: "%env(resolve:VAPID_PRIVATE_KEY)%"
 *         vapid_subject?: scalar|Param|null, // Default: "%env(resolve:VAPID_SUBJECT)%"
 *     },
 *     ui?: array{
 ...
 *     my_framework_core?: MyFrameworkCoreConfig,
 *     pwa?: PwaConfig,
